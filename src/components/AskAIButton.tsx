...
function AskAIButton({ user }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent
        className="custom-scrollbar flex h-[85vh] max-w-4xl flex-col  overflow-y-scroll"
        ref={contentRef}
      >
        <DialogHeader>
          <DialogTitle>Ask AI About Your Notes</DialogTitle>
          <DialogDescription>
            Out AI can answer any question you have about your notes
          </DialogDescription>
        </DialogHeader>
        ...
        <div
          className="mt-auto flex cursor-text flex-col rounded-lg border pt-4"
          onClick={handleClickInput}
        >
          <Textarea
            ref={textAreaRef}
            placeholder="Ask me aything about your notes..."
